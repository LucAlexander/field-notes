...
\begin{document}
	...
	\end{align}
	This theorem is vulnerable to an injection where a thoerem is applied as an instruction such that some target invariant $I$ shows our input proof $x$: $\{I \rightarrow \{B\}\}$. $f \{B\}$ now produces $I$ via injection.
\end{document}
