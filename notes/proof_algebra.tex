...
\begin{document}
	...
	Assertions inspect proof objects to determine if they do or do not show a property. If they do not show the desired property the proof fails. $a \rightsquigarrow b$ may be read $a$ shows $b$.
	$$\text{f}\,a = a \rightsquigarrow b\,b \rightarrow a$$
	Instructions may be used as a construction, which nests the proof produced by the instruction in the calling instruction.
	$$\text{f}\,x = \text{g}\,x \rightsquigarrow (x \rightarrow y)$$
