...
\begin{document}
	...
	Quantifiers allow global providence over state, and escape the trap of local term rewriting systems not truly capturing offensive dynamics due to being localized. 
	\section{Environment}
